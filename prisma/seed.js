...
async function main() {
  ...
  await criarOuAtualizarUsuario({
    nome: process.env.AUTORIZACAO_NOME || "Usuario Autorização",
    login: process.env.AUTORIZACAO_LOGIN || "autorização",
    senha: process.env.AUTORIZACAO_SENHA || "Autorização@123",
